...
def makePost(ti, bo, imgnum, flag):
	...
	client.create_photo('classicsretold', state='queue', tags=[str(ti), str(flag), 'literature', 'books', 'whales', 'sperm whale', 'classics re.told'], tweet='Moby Machinations', data='/home/dan/python-scripts/images/' + str(imgnum) + '.jpeg', caption=bo)
